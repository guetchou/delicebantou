...
@section('title', 'Driver Sign Up | Buntu Delice ')
		...
		<div class="container"> 
			...
			<div class="login-agileinfo"> 
				...
				@csrf
					...
					<div class="form-row">
                                    <div class="form-group col-md-6">
                                        <div class="qr-el qr-el-3"
                                            ...
                                            <input type="file" id="upload_file" name="image" onchange="profile(this);">
                                            @if($errors->has('image'))
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="qr-el qr-el-3"
                                            ...
                                            <label for="file-input" class="hoviringdell uploadBox" id="uploadTrigger"
                                                ...
                                                <div class="uploadText" style="font-size: 12px;">
                                                    <span style="color:#F69518;">License Image</span><br>
                                                    Size 90x90
                                                </div>
                                            </label>
					...
					<input class="agile-ltext" type="text" name="branch_name" value="{{old('branch_name')}}" placeholder="Branch Name" required="">
					<input class="agile-ltext" type="text" name="branch_address" value="{{old('branch_address')}}" placeholder="Branch Address" required="">
					<input class="agile-ltext" type="text" name="paypal_account_no" value="{{old('paypal_account_no')}}" placeholder="Paypal Account No" required="">
