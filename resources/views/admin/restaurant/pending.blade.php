@extends('layouts.app')
@section('title','Pending Restaurant')
...
<div class="content-header">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Pendings Restaurant Requests</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Restaurant</a></li>
                    <li class="breadcrumb-item active">Pendings Restaurant Requests</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                          ...
                          <a href="javascript:void(0);" onclick="$(this).find('form').submit();"
                             class="btn btn-outline-danger btn-sm">
                              ...
                              <form action="{{ route('restaurant.destroy', $restaurant->id) }}"
                                    method="post"
                                    onsubmit="return confirm('Do you really want to delete this country?');">
                                  @csrf
                                  @method('delete')
                              </form>
                          </a>
